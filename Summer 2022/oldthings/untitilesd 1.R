...
neg_new_other_pos <-read.table("aneg-new-posnonspecific.bed", header=FALSE, sep= "\t")
neg_new_true_pos <-read.table("aneg-new-truepos.bed", header=FALSE, sep= "\t")
neg_new_true_neg <-read.table("aneg-new-trueneg.bed", header=FALSE, sep= "\t")

#Orig back, with new set
orig_new_other_pos <-read.table("aorig-new-posnonspecific.bed", header=FALSE, sep= "\t")
orig_new_true_pos <-read.table("aorig-new-truepos.bed", header=FALSE, sep= "\t")
orig_new_true_neg <-read.table("aorig-new-trueneg.bed", header=FALSE, sep= "\t")

#Negative back, original set
neg_old_other_pos <-read.table("aneg-old-posnonspecific.bed", header=FALSE, sep= "\t")
neg_old_true_pos <-read.table("aneg-old-truepos.bed", header=FALSE, sep= "\t")
neg_old_true_neg <-read.table("aneg-old-trueneg.bed", header=FALSE, sep= "\t")

#Orig back, original set
orig_old_other_pos <-read.table("aorig-old-posnonspecific.bed", header=FALSE, sep= "\t")
orig_old_true_pos <-read.table("aorig-old-truepos.bed", header=FALSE, sep= "\t")
orig_old_true_neg <-read.table("aorig-old-trueneg.bed", header=FALSE, sep= "\t")
...
e<-ggplot(data=df, aes(x = dset, y=neg_true_pos_new))+ 
  geom_bar(stat="identity")+
...
f<-ggplot(data=df, aes(x = dset, y=neg_true_pos_old))+ 
  geom_bar(stat="identity")+
