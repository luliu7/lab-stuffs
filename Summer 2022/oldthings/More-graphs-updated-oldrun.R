...
#Makes the individual plots, as well as a cumulative plot
...
if (all){
  ...
  negallData <-read.table("neg-old-all_pCRMeval.txt.bed", header=TRUE, sep= "\t")
  origallData <- read.table("orig-old-all_pCRMeval.txt.bed", header=TRUE, sep = "\t")
